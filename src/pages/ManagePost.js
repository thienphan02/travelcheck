...
const ManagePost = () => {
    ...
    const fetchData = async () => {
      try {
        const [reviewResponse, commentResponse, blogResponse, blogCommentResponse] = await Promise.all([
          fetch('https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/manage/reviews', { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }),
          fetch('https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/manage/comments', { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }),
          fetch('https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/manage/blogs', { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }),
          fetch('https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/manage/blog-comments', { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } }),
        ]);
  ...
  const handleDeleteReview = async (reviewId) => {
    if (window.confirm('Are you sure you want to delete this review?')) {
      await fetch(`https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/reviews/${reviewId}`, {
        method: 'DELETE',
        headers: {
  ...
  const handleDeleteComment = async (commentId) => {
    if (window.confirm('Are you sure you want to delete this comment?')) {
      await fetch(`https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/comments/${commentId}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const handleUpdateReview = async (e) => {
    ...
    try {
      const response = await fetch(`https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/reviews/${editReviewId}`, {
        method: 'PUT',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const handleUpdateComment = async (e) => {
    e.preventDefault();
    await fetch(`https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/comments/${editCommentId}`, {
      method: 'PUT',
      headers: {
  ...
  const handleDeleteBlog = async (blogId) => {
    if (window.confirm('Are you sure you want to delete this blog?')) {
      await fetch(`https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/blogs/${blogId}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const handleDeleteBlogComment = async (commentId) => {
    if (window.confirm('Are you sure you want to delete this blog comment?')) {
      await fetch(`https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/blog-comments/${commentId}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const handleUpdateBlog = async (e) => {
    ...
    try {
      const response = await fetch(`https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/blogs/${editBlogId}`, {
        method: 'PUT',
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const handleUpdateBlogComment = async (e) => {
    e.preventDefault();
    await fetch(`https://travelcheck-hzdwesazbcead2bm.canadaeast-01.azurewebsites.net/blog-comments/${editBlogCommentId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${localStorage.getItem('token')}`,
